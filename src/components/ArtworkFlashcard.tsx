  ...
  return (
    <section className="panel overflow-hidden">
      <div className="grid gap-0 xl:grid-cols-[minmax(0,1.05fr)_minmax(24rem,0.95fr)]">
        <div className="border-b border-stone-200 bg-stone-100/70 p-4 sm:p-6 xl:border-b-0 xl:border-r">
          <div className="flex h-full flex-col gap-5">
            <ArtworkImage
              src={artwork.image}
              alt={`${artwork.title} by ${artwork.artist}`}
              className="max-h-[34rem] w-full bg-stone-200"
            />

            <div className="rounded-3xl bg-white/85 p-5 shadow-sm ring-1 ring-stone-200/70">
              ...
              <h2 className="mt-4 text-2xl font-semibold tracking-tight text-slate-950 sm:text-3xl">{artwork.title}</h2>
...
function HiddenAnswerState() {
  return (
    <div className="rounded-3xl border border-dashed border-stone-300 bg-stone-50 px-5 py-6 text-sm text-slate-600">
      <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Hide/show answer flow</div>
      ...
      <div className="mt-4 rounded-2xl bg-white px-4 py-4 text-slate-700 ring-1 ring-stone-200">
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Check yourself after reveal</div>
